                ...
                i(e, [
                    {
                        key: "show",
                        value: function () {
                            (this.isVisible = !0), this.element.classList.remove(g.HIDDEN), this.element.classList.add(g.VISIBLE), this.element.removeAttribute("aria-hidden"), this.element.setAttribute("data-custom", true);
                        },
                    },
                    {
                        key: "hide",
                        value: function () {
                            (this.isVisible = !1), this.element.classList.remove(g.VISIBLE), this.element.classList.add(g.HIDDEN), this.element.setAttribute("aria-hidden", !0), this.element.setAttribute("data-custom", false), detach(this.element);
                        },
                    },
                    {
                        key: "init",
